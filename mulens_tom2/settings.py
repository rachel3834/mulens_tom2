...
Generated by ./manage.py tom_setup on Oct. 19, 2019, 4:47 p.m.
...
SECRET_KEY = os.environ['MULENS_TOM_SECRET_KEY']
...
WSGI_APPLICATION = 'mulens_tom2.wsgi.application'
...
TOM_ALERT_CLASSES = [
    ...
    'mulens_tom2.gaiaalerts.GaiaBroker'
]
...
EXTRA_FIELDS = [
    ...
    {'name': 'Ibase', 'type': 'number'},
    {'name': 'Ilatest', 'type': 'number'},
    {'name': 'last_updated', 'type': 'datetime'},
    {'name': 'finder_naxis1', 'type': 'number'},
    {'name': 'finder_naxis2', 'type': 'number'},
    {'name': 'finder_pixscale', 'type': 'number'},
]
